...
namespace Mighty
{
    ...
    {
        [BoxGroup("Options")] public string name;

        [BoxGroup("Options")] [Tooltip("Defines when game state changes when transiting from this node to the next one ")] 
        public MightyGameStateTransitionStage transitionStage;

        [BoxGroup("Connections")] public List<string> enterGameStateNames;
        [BoxGroup("Connections")] public List<string> exitGameStateNames;
