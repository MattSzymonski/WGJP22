...
namespace Mighty
{
    ...
    public class TransformJuicer1 : MonoBehaviour
    {
        ...
        void SetStartValues()
        {
            ...
            {
                startScale = transform.GetComponent<RectTransform>().localScale;
            }
        }
            ...
            if (active)
            {
                ...
                switch (animatedElement)
                {
                    ...
                    case AnimatedElement.Scale:
                        transform.GetComponent<RectTransform>().localScale = startScale + animationDirectionMultiplier * progress;
                        break;
                }
            }
        }
